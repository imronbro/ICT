...
<body>
    ...
    <section>
        <h2>Materi Fungsi Komposisi</h2>
        <p>Pilih materi latihan untuk mempelajari tentang fungsi komposisi.</p>

        <div class="materi-container">
            <div class="materi-card">
                <h3>Materi 1</h3>
                <p>Pengenalan fungsi komposisi.</p>
                <a href="materi1.php">Mulai</a>
            </div>

            <div class="materi-card">
                <h3>Materi 2</h3>
                <p>Menentukan hasil komposisi fungsi.</p>
                <a href="materi2.php">Mulai</a>
            </div>

            <div class="materi-card">
                <h3>Materi 3</h3>
                <p>Menggabungkan dua fungsi.</p>
                <a href="materi3.php">Mulai</a>
            </div>

            <div class="materi-card">
                <h3>Materi 4</h3>
                <p>Penerapan fungsi komposisi.</p>
                <a href="materi4.php">Mulai</a>
            </div>
        </div>
    </section>
